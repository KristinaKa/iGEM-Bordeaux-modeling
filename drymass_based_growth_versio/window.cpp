...
Window::Window() { 
    ...
    L1.set_text("Simulation time (min)");
    LabelBox.pack_start(L1);
    L2.set_text("Time step (min)");
    ...
    L8.set_text("Nutrients per square");
    ...
    /* Simulation Time */
    Glib::RefPtr<Gtk::Adjustment> adjustment = Gtk::Adjustment::create(450, 0, 1800, 1); 
    ...
    /* Time step */
    adjustment = Gtk::Adjustment::create(4.19, 0.0001, 60 , 0.0050); 
    ...
    adjustment = Gtk::Adjustment::create(50, 0, 1000000, 20); 
    ...
    /* Lattice length */
    adjustment = Gtk::Adjustment::create(1000, 1, 1000, 1000); 
    ...
    adjustment = Gtk::Adjustment::create(145000, 0, 1000000000, 100); 
